...
<link href="/resource/nh/assets/img/apple-touch-icon.png"
...
<!-- Vendor CSS Files -->
<link href="/resource/nh/assets/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="/resource/nh/assets/vendor/bootstrap-icons/bootstrap-icons.css"
	rel="stylesheet">
<link href="/resource/nh/assets/vendor/aos/aos.css" rel="stylesheet">
<link href="/resource/nh/assets/vendor/fontawesome-free/css/all.min.css"
	rel="stylesheet">
<link href="/resource/nh/assets/vendor/glightbox/css/glightbox.min.css"
	rel="stylesheet">
<link href="/resource/nh/assets/vendor/swiper/swiper-bundle.min.css"
	rel="stylesheet">
...
<body class="index-page">
	...
	<header id="header" class="header sticky-top">
			...
			<div
				...
				<div class="contact-info d-flex align-items-center">
					<i class="bi bi-envelope d-flex align-items-center"> <a
						href="mailto:mybhilgaon@gmail.com">mybhilgaon@gmail.com</a>
					</i>
				</div>
				<div class="social-links d-none d-md-flex align-items-center">
					...
					<select id="langSelect"
						class="form-select form-select-sm ms-3 lang-select"
		...
		<div class="branding d-flex align-items-center">
			<div
				...
				<a class="cta-btn d-none d-sm-block" href="/home"
					data-i18n="navUpcoming">Upcoming Events</a>
			</div>
		</div>
	</header>
    ...
    <div class="mb-3">
        ...
        <form:input path="fullname"
                    ...
                    data-i18n-placeholder="formFullnamePlaceholder"
    ...
    <div class="mb-3">
        ...
        <form:input path="mobile"
                    id="mobile"
                    cssClass="form-control"
                    data-i18n-placeholder="formMobilePlaceholder"
    ...
    <form:hidden path="email"
                 value="participant@bhilgaon.com" />
        ...
        Register
			...
			<c:if test="${ empty success}">
				<div class="register-footer">
					<p data-i18n="formAlreadyAccount">
						Already have an account? <a
							href="${pageContext.request.contextPath}/login"
							data-i18n="formLoginLink">Login</a>
					</p>
				</div>
			</c:if>
		</div>
		...
		<div class="container copyright text-center mt-4">
			<p>
				© <span>Copyright</span> <strong class="px-1 sitename"
					data-i18n="siteNameFooter">People Of Bhilgaon - Aniket
					Verma</strong> <span data-i18n="rights">All Rights Reserved</span>
			</p>
			<div class="credits" data-i18n="credits">Maintained By People
				Of Bhilgaon</div>
		</div>
	</footer>
	...
	<!-- Vendor JS Files -->
	<script
		src="/resource/nh/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
